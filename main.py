...
def main() -> None:
    ...
    for linha in linhas:
        ...
        # print("tokens_linha (str):", linha)
        tokens_obj = parseExpressao(linha, tokens_linha)
        # print("tokens_linha (obj):", tokens_obj)
        exec_result = executarExpressao(tokens_obj, contexto)
        # print("print executar expressao:", exec_result)
        resultados.append(exec_result)
        tokens_por_linha_obj.append(tokens_obj)
        tokens_por_linha_str.append(tokens_linha)
    # print("Lista completa Objetos:", tokens_por_linha_obj)
    # print("Lista completa Strings:", tokens_por_linha_str)
